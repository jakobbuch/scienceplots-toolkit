"""Generate energy-related example plots using SciencePlots Toolkit.

This script demonstrates advanced usage including 24h load profiles,
quantile shading, and multi-panel seasonal comparisons.

Run with:
    uv run example_energy.py          # Without LaTeX (mathtext)
    uv run example_energy.py --latex  # With LaTeX rendering
"""
...
def generate_mock_profile(
    ...
    Args:
        peak: Peak power consumption in kW.
        base: Base load in kW.
        noise: Noise amplitude for quantile variation.

    Returns:
        Tuple of (x, mean, q10, q90) arrays for 24h profile.
    """
